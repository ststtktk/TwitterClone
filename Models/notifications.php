 ...
 * @return int|false
 * received_user_id:通知を受け取るid,sent_user_id:通知した方のid,message:メッセージ
 */
...
function findNotifications(int $user_id)
{
    ...
    $query = <<<SQL
        ...
        FROM
            -- notificationsテーブルをNという別名に設定
            notifications AS N
            -- 誰がいいね！してくれたか知るためのJOIN
            JOIN
