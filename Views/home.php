        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="notification" class="nav-link"><img src="../Views/img/icon-notification.svg" alt=""></a></li>
                    ...
                    <div class="content">
                        <div class="name">
                            <a href="profile.php?user_id=1">
                                ...
                                <span class="username">@taro ・23日前</span>
                            </a>
                        </div>
                        <p>今プログラミングしています</p>
                        <div class="icon-list">
                    ...
                    <div class="content">
                        <div class="name">
                            <a href="profile.php?user_id=2">
                                ...
                                <span class="username">@jiro ・24日前</span>
                            </a>
                        </div>
                        <p>コワーキングスペーススペースをオープンしました。</p>
